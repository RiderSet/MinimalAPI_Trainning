...
- Create Angular project with ng: `ng new minimalapi_second_angular.client --defaults --skip-install --skip-git `.
...
- Create project file (`minimalapi_second_angular.client.esproj`).
- Create `launch.json` to enable debugging.
- Create `nuget.config` to specify location of the JavaScript Project System SDK (which is used in the first line in `minimalapi_second_angular.client.esproj`).
